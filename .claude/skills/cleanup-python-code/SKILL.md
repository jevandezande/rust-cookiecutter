...
Use the `write-python-code` skill to understand code conventions.
...
5. Verify docstrings on all public APIs (follow `write-python-docstrings` skill conventions).
